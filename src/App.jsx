...
function getRouteFromUrl() {
  ...
  return { slug, isBartender, isAdmin };
}
...
export default function App() {
  ...
  const { slug, isBartender, isAdmin } = getRouteFromUrl();
  ...
  // Age verification gate (patron view only)
  const needsAgeVerification = !isAdmin && !isBartender && venue?.require_age_verification && !ageVerified;
