...
function PatronView({ venue, menu, BRAND }) {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // Generate confirmation and create order
        ...
        <div style={{ padding: "0 20px 100px" }}>
          ...
          {cart.length === 0 ? (
            ...
            <>
              ...
              <p style={{ textAlign: "center", fontSize: 10, color: BRAND.dimText, marginTop: 10, fontFamily: "'Space Mono', monospace", letterSpacing: 1 }}>SECURE PAYMENT VIA SQUARE</p>
            </>
          )}
        </div>
      )}
