...
export default function App() {
  ...
  const { slug, isBartender, isQR } = getRouteFromUrl();
  ...
  // Age verification gate (patron view only — not bartender or QR)
  const needsAgeVerification = !isBartender && !isQR && venue?.require_age_verification && !ageVerified;
